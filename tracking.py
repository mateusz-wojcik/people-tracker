...
class CentroidTracker():
    ...
    def update(self, rects):
        # The format of the rects parameter is assumed to be a tuple with this 
        ...
        if len(rects) == 0:
            ...
            for objectID in list(self.disappeared.keys()):
                ...
                # frames where a given object has been marked as missing, deregister it
        ...
        # otherwise, are are currently tracking objects so we need to try to match
        # the input centroids to existing object centroids
            ...
            # input centroids, respectively -- our goal will be to match 
            # an input centroid to an existing object centroid
            ...
            # the row with the smallest value is at the *front* of the index list
            ...
            # greater than the number of input centroids we need to check and 
            # see if some of these objects have potentially disappeared
